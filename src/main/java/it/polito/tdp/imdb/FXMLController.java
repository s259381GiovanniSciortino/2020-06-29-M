...
public class FXMLController {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	if(boxAnno.getValue()==null) {
    		txtResult.appendText("Seleziona un mese appropriato");
    		return;
    	}
    	String msg = model.doCreaGrafo(boxAnno.getValue());
    	txtResult.appendText(msg);
    	boxRegista.getItems().clear();
    	boxRegista.getItems().addAll(model.getDirectors());
    }
    ...
    void doRegistiAdiacenti(ActionEvent event) {
    	...
    	String msg = model.doRegistiAdiacenti(boxRegista.getValue());
    	txtResult.appendText(msg);
    }
